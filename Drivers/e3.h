...
//application will then sit at this location+1 to the end of program memory.
   ...
   #define APPLICATION_RAM_START 0x28  //see SCRATCH_RAM_END
   #define APPLICATION_RAM_END   0x1FF
   ...
   */
   ...
   #byte SFR_PCLATU=getenv("SFR:PCLATU")
   #byte SFR_PCLATH=getenv("SFR:PCLATH")
#endif

#define LOADER_PROXY_SIZE     0x20
...
#define CALL_INSTRUCTION(x)   \
   ...
   #asm  \
    ...
    __CALL_INSTRUCTION_RETURN:   \
      ...
      MOVWF SFR_PCLATH  \      
      MOVPUW __CALL_INSTRUCTION_RETURN  \
      MOVWF SFR_PCLATU  \      
   #endasm
...
#define GOTO_INSTRUCTION(x)   \
   ...
   #build(reset=APPLICATION_START, interrupt=APPLICATION_ISR, stack=20, NOSLEEP_LOCK)   //loader uses 10 stack locations in isr
