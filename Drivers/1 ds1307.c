...
//========================================
//========================================
void ds1307_get_f(BYTE &dinh_dang)
{
   i2c_bat_dau(8);
   i2c_st();
   i2c_write(0xD1);
   dinh_dang = i2c_read(0);
   i2c_sto();    
}
//======================================== 
void ds1307_set_f(dinh_dang)
{ 
   i2c_bat_dau(8);
   i2c_write(dinh_dang&0x7f); // REG 2 
   i2c_sto(); 
} 
//======================================== 
...
//========================================
void ds1307_doc_phut(BYTE &phut)
{
   //i2c_start();
   //i2c_write(0xD0);                            
   //i2c_write(0x00); // Start at REG 0 - Seconds 
   ...
   i2c_st();
   i2c_write(0xD1);
   phut = bcd2bin(i2c_read(0));
   i2c_sto();    
}
//========================================
void ds1307_doc_gio(BYTE &gio)
{
   //i2c_start();
   //i2c_write(0xD0);                            
   //i2c_write(0x00); // Start at REG 0 - Seconds 
