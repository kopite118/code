...
//========================================  
#define nam_bu_lai 16
void tinh_am_lich(int8 &ngay,&thang,&nam) // tính am lich tu ngay thang nam duong lich
{
   int8 luu;
   int8 ngay_a,thang_a;
   int8 ngay_am_dau_thang_duong,ngay_duong_dau_thang_am;     
   if((nam-nam_bu_lai)>20)// cho phep den nam 2030
      return; 
   
   ngay_am_dau_thang_duong = ALdauthangDL[nam-nam_bu_lai][thang-1]; // 19                   
   ngay_duong_dau_thang_am = DLdauthangAL[nam-nam_bu_lai][thang-1]; // 13   
   luu=ngay_duong_dau_thang_am-ngay; // -10 // 246
   if(luu==0) // khi ngay duong dau thang am trung voi ngay                                           
   {
      ngay_a = 1; // ngay am = 1, ngay dau cua thang am lich
      thang_a = thangALdauthangAL[nam-nam_bu_lai][thang-1]; // than am là thanh co ngay 1 dau tien trong thang duong lich 
   }
   else                                                                                                                                                           
   if(luu>31) // khi ngay duong dau thang am <= ngay hien tai
   {                                                                                                  
      ngay_a = (ngay-ngay_duong_dau_thang_am+1);//
      thang_a = thangALdauthangDL[nam-nam_bu_lai][thang];
   }  
   else // khi ngay hien tai < ngay duong dau tháng am
   {
      ngay_a = (ngay+ngay_am_dau_thang_duong-1);//
      thang_a = thangALdauthangDL[nam-nam_bu_lai][thang-1];
   }       
   if(thang-thang_a>100&&thang-thang_a<255)
   {
      nam--;  
   }         
   thang=thang_a;
