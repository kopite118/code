...
{   
   unsigned char N_AL_DT_DL2; 
   unsigned char T_AL_DT_DL2; 
   unsigned char SN_CT_AL2;
   unsigned char TN_B_THT2;
   unsigned char N_AL_DT_DL_TT2;
   unsigned char T_AL_DT_DL_TT2;

//   union LUNAR_RECORD lr;

   //lr.Word = LUNAR_CALENDAR_LOOKUP_TABLE[(SolarYear-BEGINNING_YEAR)*12+SolarMonth -1]; 
   Word = LUNAR_CALENDAR_LOOKUP_TABLE[(SolarYear-BEGINNING_YEAR)*12+SolarMonth -1]; 
   N_AL_DT_DL2 = N_AL_DT_DL;
   T_AL_DT_DL2 = T_AL_DT_DL;
   SN_CT_AL2 = SN_CT_AL + 29;
   TN_B_THT2 =  TN_B_THT;

   Word = LUNAR_CALENDAR_LOOKUP_TABLE[(SolarYear-BEGINNING_YEAR)*12+SolarMonth];
   N_AL_DT_DL_TT2 = N_AL_DT_DL;
   T_AL_DT_DL_TT2 = T_AL_DT_DL;

   // Tinh ngay & thang
   if(N_AL_DT_DL2 == SN_CT_AL2 && N_AL_DT_DL_TT2 == 2)
   {
       if(SolarDay==1)
      {
          (*LunarDay) = N_AL_DT_DL2;
         (*LunarMonth) = T_AL_DT_DL2;
      }
      else if(SolarDay==31)
      {
          (*LunarDay) = 1;
         (*LunarMonth) = T_AL_DT_DL_TT2;
      }
      else
      {
          (*LunarDay) = SolarDay - 1;
         ...
         {
             (*LunarMonth) = T_AL_DT_DL2==12?1:(T_AL_DT_DL2 + 1);
         } 
      }
   }
   else
   {
       (*LunarDay) = SolarDay + N_AL_DT_DL2 - 1;
      if((*LunarDay)<= SN_CT_AL2)
      {
          (*LunarMonth) = T_AL_DT_DL2;
      }
      else
      {
         ...
         (*LunarMonth) = T_AL_DT_DL2 + 1 - TN_B_THT2;
...
//   union LUNAR_RECORD lr;
   ...
   Word = LUNAR_CALENDAR_LOOKUP_TABLE[(nam-BEGINNING_YEAR)*12+thang -1];
   N_AL_DT_DL2 = N_AL_DT_DL;
   T_AL_DT_DL2 = T_AL_DT_DL;
   SN_CT_AL2 = SN_CT_AL + 29;
   TN_B_THT2 =  TN_B_THT;

   Word = LUNAR_CALENDAR_LOOKUP_TABLE[(nam-BEGINNING_YEAR)*12+thang];
   N_AL_DT_DL_TT2 = N_AL_DT_DL;
   T_AL_DT_DL_TT2 = T_AL_DT_DL;
   ...
   if(N_AL_DT_DL2 == SN_CT_AL2 && N_AL_DT_DL_TT2 == 2)
   {
      ...
      {
         (ngay_am) = N_AL_DT_DL2;
         (thang_am) = T_AL_DT_DL2;
      }
      else if(ngay==31)
      {
         (ngay_am) = 1;
         (thang_am) = T_AL_DT_DL_TT2;
      }
      else
      {
         (ngay_am) = ngay - 1;
         ...
         {
            (thang_am) = T_AL_DT_DL2==12?1:(T_AL_DT_DL2 + 1);
         }
      }
   }
   else
   {
      (ngay_am) = ngay + N_AL_DT_DL2 - 1;
      if((ngay_am)<= SN_CT_AL2)
      {
         (thang_am) = T_AL_DT_DL2;
      }
      else
      {
         ...
         (thang_am) = T_AL_DT_DL2 + 1 - TN_B_THT2;
