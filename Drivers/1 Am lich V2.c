...
#define al_tong_so_nam 11
const int8 ALdauthangDL[al_tong_so_nam][12] = { // ngay âm dâu thang duong lich
...
const int8 thangALdauthangDL[al_tong_so_nam][12] = { // thang am dau thang duong lich
...
const int8 DLdauthangAL[al_tong_so_nam][12] = { // ngay duong dau thang am lich
...
const int8 thangALdauthangAL[al_tong_so_nam][12] = { // thang am co ngay 1 dau tien trong thang 
...
//========================================  
#define nam_bu_lai 20
void tinh_am_lich() // tính am lich tu ngay thang nam duong lich
{
   int8 luu;
   int8 ngay_a,thang_a;
   int8 ngay_am_dau_thang_duong,ngay_duong_dau_thang_am;     
   if((nam_am-nam_bu_lai)>20)// cho phep den nam 2030
      return; 
   
   ngay_am_dau_thang_duong = ALdauthangDL[nam_am-nam_bu_lai][thang_am-1]; // 19                   
   ngay_duong_dau_thang_am = DLdauthangAL[nam_am-nam_bu_lai][thang_am-1]; // 13   
   luu=ngay_duong_dau_thang_am-ngay_am; // -10 // 246
   if(luu==0) // khi ngay duong dau thang am trung voi ngay                                           
   {
      ngay_a = 1; // ngay am = 1, ngay dau cua thang am lich
      thang_a = thangALdauthangAL[nam_am-nam_bu_lai][thang_am-1]; // than am là thanh co ngay 1 dau tien trong thang duong lich 
   }
   else                                                                                                                                                           
   if(luu>31) // khi ngay duong dau thang am <= ngay hien tai
   {                                                                                                  
      ngay_a = (ngay_am-ngay_duong_dau_thang_am+1);//
      thang_a = thangALdauthangDL[nam_am-nam_bu_lai][thang_am];
   }  
   else // khi ngay hien tai < ngay duong dau tháng am
   {
      ngay_a = (ngay_am+ngay_am_dau_thang_duong-1);//
      thang_a = thangALdauthangDL[nam_am-nam_bu_lai][thang_am-1];
   }       
   if(thang_am-thang_a>100&&thang_am-thang_a<255)
   {
      nam_am--;  
   }         
   thang_am=thang_a;
